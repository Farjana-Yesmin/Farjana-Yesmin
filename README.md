...
- 📚 **Research Output:** 15+ papers (published & under review) at venues including Springer LNNS, IEEE conferences, Nature Portfolio journals, and top-tier AI conferences
...
|------|-------------------|--------|
| **Privacy-Preserving AI** | MedHE: Communication-efficient FL with adaptive gradient sparsification for healthcare | Under Review (FLICS 2026) |
| **Medical Imaging** | Joint denoising & 3D point cloud reconstruction from single medical images | Under Review (MICCAI 2026) |
| **AI Fairness** | Fairness-aware representation learning for ECG-based disease prediction | Under Review (MobiHealth 2026) |
...
| **Explainable AI** | Rule-augmented neural networks for trustworthy decision-making | Under Review (xAI 2026) |
...
| **Multimodal Learning** | Cross-domain evaluation for multi-task learning in NLP | Published (AI eJournal 2025) |
...
**Accepted Papers:**
- **Yesmin, F.**, Akter, R. (2026). "Toward Equitable Recovery: A Fairness-Aware AI Framework for Prioritizing Post-Flood Aid in Bangladesh." *Accepted for oral presentation at CCAI 2026, Nanjing, China. IEEE Conference Proceedings.*
...
**Under Review:**
- 10+ papers at top venues including MICCAI, FLICS, MobiHealth, xAI, ECML PKDD, and more
...
- Network Theory • Information Theory • Rule-Augmented Neural Networks • Attention Mechanisms
...
- 27th ACM International Conference on Multimodal Interaction (ICMI)
